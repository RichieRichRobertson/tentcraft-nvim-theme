...
---@diagnostic disable: undefined-global
  ...
  return {
    ...
    SpecialKey     { fg=Sentry, bg=logosecondary }, -- Unprintable characters: text displayed differently from what it really is. But not 'listchars' whitespace. |hl-Whitespace|
